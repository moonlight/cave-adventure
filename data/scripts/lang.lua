...
conv =
{
	...
	NO_WAY_OUT = {{lang.PLAYER, "No way I can get out of this cave alive through this!"}},
	NO_ESCAPE  = {{lang.PLAYER, "Escaping through this would kill me for sure."}},

	REFRESHING = {{lang.PLAYER, "Ah, refreshing."}},
	COULD_USE_THAT = {{lang.PLAYER, "I could use some of that."}},
	MUCH_BETTER = {{lang.PLAYER, "That's much better."}},

	FIRE_1 = {{lang.PLAYER, "It's burning just fine."}},
	FIRE_2 = {{lang.PLAYER, "It's too big to carry along. Besides, I'd only use it for evil."}},
	FIRE_3 = {{lang.PLAYER, "Ouch! Fire hot."}},
	FIRE_4 = {{lang.PLAYER, "Is this a logfire I see before me?"}},
